...
public class CreatePurchaseOrder_TC extends BaseClass
{
	...
	@Test
	public void CreatePurchaseOrder_Test() throws Throwable
	{
		...
		Log.startTestCase("CreatePurchaseOrder_Test");
		...
		{
			Assert.assertTrue(true);
			Log.info("Found- "+ strMsg);
		}
		else
		{
			Log.error("Fail-Did not find- "+ strMsg, driver);
			Assert.assertTrue(false);
		}
